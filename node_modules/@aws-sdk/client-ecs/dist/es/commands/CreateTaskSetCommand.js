 ...
 */
var CreateTaskSetCommand = /** @class */ (function (_super) {
    __extends(CreateTaskSetCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function CreateTaskSetCommand(input) {
        var _this = 
     ...
     * @internal
     */
    CreateTaskSetCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "ECSClient";
        var commandName = "CreateTaskSetCommand";
    ...
    CreateTaskSetCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1CreateTaskSetCommand(input, context);
    };
    CreateTaskSetCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1CreateTaskSetCommand(output, context);
    };
    return CreateTaskSetCommand;
}($Command));
export { CreateTaskSetCommand };
