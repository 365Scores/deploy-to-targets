...
var serializeAws_json1_1RegisterTaskDefinitionRequest = function (input, context) {
    return __assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign({}, (input.containerDefinitions !== undefined &&
    ...
    })), (input.cpu !== undefined && input.cpu !== null && { cpu: input.cpu })), (input.executionRoleArn !== undefined &&
...
var serializeAws_json1_1TaskOverride = function (input, context) {
    return __assign(__assign(__assign(__assign(__assign(__assign({}, (input.containerOverrides !== undefined &&
