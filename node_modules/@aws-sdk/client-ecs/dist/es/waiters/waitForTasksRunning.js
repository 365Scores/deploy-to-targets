...
var checkState = function (client, input) { return __awaiter(void 0, void 0, void 0, function () {
    var result_1, returnComparator, _a, _b, anyStringEq_4, returnComparator, _c, _d, anyStringEq_4, returnComparator, allStringEq_5, _e, _f, element_4, exception_1;
            ...
            case 1:
                ...
                try {
                    returnComparator = function () {
                        var flat_1 = [].concat.apply([], __spread(result_1.tasks));
                ...
                try {
                    returnComparator = function () {
                        var flat_1 = [].concat.apply([], __spread(result_1.failures));
                        var projection_3 = flat_1.map(function (element_2) {
