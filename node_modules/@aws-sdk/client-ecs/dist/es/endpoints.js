...
var AWS_TEMPLATE = "ecs.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "ecs.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "ecs.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "ecs.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "ecs.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "ecs" }, regionInfo));
};
